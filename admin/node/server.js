...
var userCon=mongoose.createConnection(config.USER_URI);
mongoose.connection.on('error', function(err) {
  console.log('Error: Could not connect to USER. Did you forget to run `mongod`?'.red);
});

var User = userCon.model('User', userSchema);

/* start devices datatable */
...
var devCon=mongoose.createConnection(config.DEV_URI);
mongoose.connection.on('error', function(err) {
  console.log('Error: Could not connect to DEV. Did you forget to run `mongod`?'.red);
});

var Dev = devCon.model('Dev', devSchema);
...
/*
 |--------------------------------------------------------------------------
 | GET /devices --20151111 hy
 |--------------------------------------------------------------------------
 */
app.get('/devices', function(req, res) {
  //Dev.count({},function(err,count){
